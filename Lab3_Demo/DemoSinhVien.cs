...
namespace Lab3_Demo
{
    public partial class frmSinhVien : Form
    {
        ...
        private void ThietLapThongTin(SinhVien sv)
        {
            ...
            this.pbHinhAnh.ImageLocation = sv.Hinh;
            if (sv.GioiTinh)
        ...
        private void LoadListView()
        {
            ...
            tspSoLuong.Text = string.Empty;
            tspSoLuong.Text = "Tổng số sinh viên:" + lvSinhVien.Items.Count;
        }
        ...
        private void btnMacDinh_Click_1(object sender, EventArgs e)
        {
            ...
            this.txtDiaChi.Text = "";
            this.cbxLop.Text = this.cbxLop.Items[0].ToString();
            this.txtHinh.Text = "";
            this.pbHinhAnh.ImageLocation = "";
            this.rdNam.Checked = true;
        ...
        private void OpenFile()
        {
            ...
            openFileDialog.Filter = "JPGE file |*.jpg;*.jpge" + "bitmap files |*.bmp;" + "all file (*.*)|*.*";
        ...
        private void tspSoLuong_Click(object sender, EventArgs e)
        {
        ...
        private void màuChữToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                lvSinhVien.ForeColor = cdl.Color;
            }    
        }
        ...
        private void Tim(int Kieu, string Data)
        {
            lvSinhVien.Items.Clear();
            List<SinhVien> sinhVien = new List<SinhVien>();
            sinhVien = qlsv.Tim(Kieu, Data);
            if (sinhVien.Count == 0)
        ...
        private void SapXep(int kieu)
        {
            if (kieu == 1)
            {
                MessageBox.Show("Sắp xếp sinh viên theo mã số giảm dần");
                qlsv.SapXep(1);
            }
            if (kieu == 2)
            {
                MessageBox.Show("Sắp xếp sinh viên theo htên giảm dần");
                qlsv.SapXep(2);
            }
            if (kieu == 3)
            {
